...
<head>
    ...
    <link rel="stylesheet" href="/maven-vrm/static/css/base.css">
    <link rel="stylesheet" href="/maven-vrm/static/css/profile.css">
...
<body class="w100">
        ...
        <div class="container">
            ...
            <div id="profile_tab">
                <ul class="profile_tab_header f_left clearfix">
                    <li><a href="/maven-vrm/front/user/profile.action?id=${sessionScope._front_user.id }">更改资料</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="/maven-vrm/front/user/avatar.action?id=${sessionScope._front_user.id }">更改头像</a></li>
                    <li class="profile_tab_line">|</li>
                    <li><a href="/maven-vrm/front/user/password.action?id=${sessionScope._front_user.id }">密码安全</a></li>
                </ul>
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                            <c:if test="${empty user.headUrl}">
                                <img  src="/maven-vrm/static/img/avatar_lg.png">
                            </c:if>
                        ...
                        <div class="profile_ifo_area">
                            <form action="/maven-vrm/front/user/profile.action" method="post">
                                ...
                                <div class="form_group">
                                    ...
                                    <input type="date"  name="birthday"  value="<fmt:formatDate value="${user.birthday}" pattern="YYYY-MM-dd"></fmt:formatDate>" >
                                ...
                                <div class="form_submit dd">
                                	...
                                	<input type="hidden" name="head_url" value="/pic/${user.headUrl}">
                                    <input type="submit"  value="保&#x3000;存">
                                    <a href="/maven-vrm/front/user/profile.action">重置</a>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script src="/maven-vrm/static/js/jquery.cityselect.min.js"></script>
