...
<footer>
	<ul>
		<li>
			<img src="/maven-vrm/static/img/footer_logo.png" alt="" draggable="false">
		</li>
		<li class="mt25">
			<h3>各校区地址</h3>
			<ul>
		...
		<li class="mt25">
			...
			<ul id="foo_icon">
				...
				<li class="erwei">
					<br>
					<div>
						<img class="weixin" src="/maven-vrm/static/img/微信公众号.png" alt="" draggable="false">
						<img class="weibo" src="/maven-vrm/static/img/微博公众号.png" alt="" draggable="false">
					</div>
				</li>
			</ul>
		</li>
...
<div class="mask hidden" id="loginDiv">
	<div class="mask_content">
		<div class="mask_content_header">
			<img src="/maven-vrm/static/img/logo.png" alt="" class="ma">
		</div>
		<div class="mask_content_body">
			<form id="loginForm" action="front/user/login.action" method="post">
				...
				<div id="forget">
					<a href="/maven-vrm/front/user/forget_pwd.action">忘记密码？</a>
				</div>
