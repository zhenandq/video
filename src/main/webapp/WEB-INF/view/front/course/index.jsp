...
<body class="w100">
	...
	<div id="app">
		<!--banner图-->
		<div class="banner"
			style="background-image: url('/maven-vrm/static/img/banner-${subjectId}.jpg')"></div>
						...
						<c:forEach items="${course.videoList }" var="video">
							...
							<div class="thum" style="background-image: url(${video.videoImageUrl})"></div>
								...
								<div class="classify-v-info">
									...
									<img src="/maven-vrm/static/img/count.png" alt="">${video.videoPlayTimes }</span>
									<span class="duration" title="视频时长">
										<img src="/maven-vrm/static/img/player.png" alt="">${video.videoLength }</span>
								</div>
							</li>
						</c:forEach>
					</ul>
	...
	<script type="text/javascript">
		function getVideo(id){
			...
			location.href='/maven-vrm/front/video/index.action?videoId='+id+'&subjectId='+subjectId;
		}
	</script>
