...
<div>
    ...
    <script src="/maven-vrm/static/js/video.js"></script>
    <script>
        $(function () {
        	var id = $('#videoId').val();
           $('#content').load('/maven-vrm/front/video/videoData.action?videoId='+id);
           
           //播放量统计,不需要返回结果处理
           $.get('/maven-vrm/front/video/state.action?videoId='+id);
		});
    </script>
</body>
