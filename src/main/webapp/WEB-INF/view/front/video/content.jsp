...
<div class="catalog">
	<div class="container">
		...
		<c:forEach items="${videoList}" var="video" >
			<div class="chapter">
				<p class="biaoti"><a href="/maven-vrm/front/video/index.action?videoId=${video.id}&subjectId=${course.subjectId}">${video.videoTitle}</a></p>
				<p class="lecturer">${video.videoDescr}</p>
				<p class="lecturer">讲师：${video.speakerName}</p>
				<div class="v-info">
					<span class="count"><img src="/maven-vrm/static/img/count.png" alt="">${video.videoPlayTimes}</span>
					<span class="duration"><img src="/maven-vrm/static/img/player.png" alt="">${video.videoLength}</span>
				</div>
			</div>
		</c:forEach>
