	...
	<div class="container theme-showcase" role="main">
		...
		<form class="form-horizontal" action="${pageContext.request.contextPath}/video/updateVideo.action" method="post">
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="text" name="videoTitle" value="${video.videoTitle }" class="form-control" placeholder="视频标题">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-md-10">
					<input type="text" name="videoLength" value="${video.videoLength}" class="form-control" placeholder="视频时长(秒)">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-2 control-label">封面图片</label>
				<div class="col-md-10">
					<input type="text" name="videoImageUrl" value="${ video.videoImageUrl}" class="form-control" placeholder="视频封面图片地址,网络图片">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-2 control-label">视频播放地址</label>
				<div class="col-md-10">
					<input type="text" name="videoUrl" value="${video.videoUrl}" class="form-control" placeholder="视频播放地址,网络地址">
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-2 control-label">视频简介</label>
				<div class="col-md-10">
					<textarea class="form-control" name="videoDescr" style="height: 100px;">${video.videoDescr} </textarea>
				</div>
			</div>
